...
PairStyle(aniso,PairAniso)

#else

#ifndef LMP_PAIR_ANISO_H
#define LMP_PAIR_ANSIO_H

#include "pair.h"

namespace LAMMPS_NS {

class PairAniso : public Pair {
 public:
  PairAniso(LAMMPS *lmp);
  virtual ~PairAniso();
 ...
 protected:
  ...
  double cosine_sq_E(const double r, const double E, const double sigma, const double rcut);
  double dcosine_sq_dr(const double r, const double E, const double sigma, const double rcut);
};
